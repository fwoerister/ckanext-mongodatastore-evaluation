...
# field matches fulltext query. For the resulting datasets a PID is issued. Subsequently the datasets is modified
...
class PidForFulltextQueryFunctionalTest(GenericFunctionalTest):

    def __init__(self, results_dir, name):
        super(PidForFulltextQueryFunctionalTest, self).__init__(results_dir, name)
    ...
    def _execute_steps(self):
        self._stored_query_results = []
        self._pid = ckan.client.action.issue_pid(resource_id=self._resource_id, q='Aus')
        ...
        new_record = {'id': 1, 'Country': 'Australia', 'Year': 2000, 'Debt': None, 'RGDP': None, 'GDP': None,
                      'dRGDP': 1234, 'GDPI': None, 'GDP1': None, 'GDP2': None, 'RGDP1': None,
                      'RGDP2': None, 'GDPI1': None, 'GDPI2': None, 'Infl': 1234, 'Debt1': None, 'Debt2': None,
                      'Debtalt': None, 'GDP2alt': 1234, 'GDPalt': None, 'RGDP2alt': None, 'debtgdp': None,
