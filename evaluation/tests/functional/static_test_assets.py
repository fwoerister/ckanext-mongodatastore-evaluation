PACKAGE = {
    'name': 'rr-dataset', 'title': 'Reinhard&Rogoff Datasets',
    'private': False,
    'owner_org': 'tu-wien',
...
RESOURCE_FILE_LOCATION = 'data/datasets/countries_dataset.csv'
...
MODIFIED_RECORD = {'id': 1, 'Country': 'Australia', 'Year': 2000, 'Debt': None, 'RGDP': None, 'GDP': None,
