...
from evalutil import querystore, handle
...
logging.info("Start execution of 'tc4_4'")
...
# STEPS
results = []
pid = ckan.client.action.issue_pid(resource_id=resource_id, filters={'Country': 'France'}, projection={'id': 1}, sort="Dept asc")
...
# EXPECTED RESULTS
hash.verify_all_elements_have_same_hash(results, hash.calculate_hash)
handle_pid = querystore.verify_handle_was_assigned(pid)
handle.verify_handle_resolves_to_pid(handle_pid, pid)

logging.info("'tc4_4' successfully executed!")
