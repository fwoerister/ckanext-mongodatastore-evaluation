...
from evalutil.script import run_r_script
...
log_hashes.append(run_r_script('RR.R', 'rest-run1'))
...
log_hashes.append(run_r_script('RR.R', 'rest-run2'))
...
git_util.purge_repository()
git_util = GitUtil('http://root:gitlab_passwd@localhost:8081/root/rr-experiment.git', '1.0')
log_hashes.append(run_r_script('RR.R', 'rest-run3'))
